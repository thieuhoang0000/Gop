...
try:
    ...
    if not stored_key:
        ...
        console.print(f"[bold red][bold yellow][/bold yellow][bold white][/bold white][bold magenta]VƯỢT LINK ĐỂ LẤY KEY FREE:[/bold magenta][/bold red][bold green] {short_link}[/bold green]")
